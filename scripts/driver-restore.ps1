...
try {
    ...
    try {
        ...
        Write-Log "  [OK] Toolkit driver removed"
    } catch {
    ...
    try {
        ...
        Write-Log "  [OK] Original driver restored"
    } catch {
    ...
    if ($KeepBackup) {
        ...
        try {
            ...
            Write-Log "  [OK] Backup renamed to: driver_playstation_vr2_orig.dll.bak"
        } catch {
        ...
        try {
            ...
            Write-Log "  [OK] Backup file removed"
        } catch {
